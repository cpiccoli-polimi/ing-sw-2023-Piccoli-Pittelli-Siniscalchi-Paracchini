...
class CommonGoalCard1Test {
    ...
    void CommonGoal1SatisfiedTest(){
        ...
        bookshelf[5][3]=new PublicObjectCard(2,5,3);
        bookshelf[5][4]=new PublicObjectCard(2,5,4);
        ...
        bookshelf[4][3]=new PublicObjectCard(101,4,3);
    ...
    void CommonGoal1SatisfiedDifferentShapeTest(){
        ...
        bookshelf[0][4]=new PublicObjectCard(23,0,0);
        bookshelf[1][4]=new PublicObjectCard(24,0,0);
        bookshelf[1][3]=new PublicObjectCard(25,0,0);
        bookshelf[1][2]=new PublicObjectCard(26,0,0);
        bookshelf[2][2]=new PublicObjectCard(27,0,0);
        bookshelf[3][2]=new PublicObjectCard(28,0,0);
        bookshelf[3][3]=new PublicObjectCard(29,0,0);
        bookshelf[3][4]=new PublicObjectCard(30,0,0);

        bookshelf[2][3]=new PublicObjectCard(45,0,0);
        bookshelf[2][4]=new PublicObjectCard(46,0,0);

        bookshelf[1][0]=new PublicObjectCard(47,0,0);
